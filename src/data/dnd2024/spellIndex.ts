...
const SRD52_SPELL_ROWS: Row[] = [
  ['Acid Splash', 0, verifiedSpellIndex('酸液飞溅', '塑能', ['术士', '法师'], '0环.htm', 'Acid_Splash')], ['Aid', 2], ['Alarm', 1], ['Alter Self', 2], ['Animal Friendship', 1],
  ...
  ['Charm Monster', 4], ['Charm Person', 1], ['Chill Touch', 0, verifiedSpellIndex('颤栗之触', '死灵', ['术士', '邪术师', '法师'], '0环.htm', 'Chill_Touch')], ['Chromatic Orb', 1], ['Circle of Death', 6],
  ...
  ["Crusader's Mantle", 3], ['Cure Wounds', 1], ['Dancing Lights', 0, verifiedSpellIndex('舞光术', '幻术', ['吟游诗人', '术士', '法师'], '0环.htm', 'Dancing_Lights')], ['Darkness', 2], ['Darkvision', 2],
  ...
  ['Raise Dead', 5], ["Rary's Telepathic Bond", 5], ['Ray of Enfeeblement', 2], ['Ray of Frost', 0, verifiedSpellIndex('冷冻射线', '塑能', ['术士', '法师'], '0环.htm', 'Ray_of_Frost')], ['Ray of Sickness', 1],
  ['Regenerate', 7], ['Reincarnate', 5], ['Remove Curse', 3], ['Resistance', 0, verifiedSpellIndex('抵抗术', '防护', ['牧师', '德鲁伊'], '0环.htm', 'Resistance')], ['Resurrection', 7],
  ['Reverse Gravity', 7], ['Revivify', 3, verifiedSpellIndex('回生术', '死灵', ['牧师', '德鲁伊', '圣武士', '游侠'], '3环.htm', 'Revivify')], ['Rope Trick', 2], ['Sacred Flame', 0, verifiedSpellIndex('圣火术', '塑能', ['牧师'], '0环.htm', 'Sacred_Flame')], ['Sanctuary', 1],
  ...
  ['Shield of Faith', 1], ['Shillelagh', 0, verifiedSpellIndex('橡棍术', '变化', ['德鲁伊'], '0环.htm', 'Shillelagh')], ['Shining Smite', 2], ['Shocking Grasp', 0, verifiedSpellIndex('电爪', '塑能', ['术士', '法师'], '0环.htm', 'Shocking_Grasp')], ['Silence', 2],
