...
const map = replayMapRuntimeEvents([{ eventKind: 'map.token_added', seq: 1, payload: { token: { id: 'safe-token', name: 'Unknown enemy', x: 50, y: 50, size: 'medium', sourceType: 'unknown', hpDisplay: { kind: 'stage', stage: 'wounded' }, acDisplay: { kind: 'unknown' }, visibility: 'publicObserved', relation: 'enemy' } } }], 'safe-map');
