...
export function buildCocVaultShellStrings(t: (key: string) => string): ActorVaultShellStrings {
  return {
    ...
    copyConflictsAsNew:      t('multiWorkspace.actorVault.copyConflictsAsNew'),
    copyConflictsAsNewNote:  t('multiWorkspace.actorVault.copyConflictsAsNewNote'),
    copyAsNewConflictNotice: t('multiWorkspace.actorVault.copyAsNewConflictNotice'),
    copyAsNewResultTitle:    t('multiWorkspace.actorVault.copyAsNewResultTitle'),
    copyAsNewResultCopied:   t('multiWorkspace.actorVault.copyAsNewResultCopied'),
    copyAsNewResultSkippedFailed: t('multiWorkspace.actorVault.copyAsNewResultSkippedFailed'),
    copyAsNewResultMappings: t('multiWorkspace.actorVault.copyAsNewResultMappings'),
    copyAsNewNoOverwriteNote: t('multiWorkspace.actorVault.copyAsNewNoOverwriteNote'),
