...
interface VerificationReport {
  ...
  schema: Awaited<ReturnType<typeof checkPostgresGeneratedArtifactSchemaReadiness>>;
  smoke: Awaited<ReturnType<typeof runPostgresGeneratedArtifactRepositoryReadOnlySmoke>>;
  notes: string[];
}
