...
interface VerificationReport {
  ...
  schema: Awaited<ReturnType<typeof checkPostgresRuntimeEventSchemaReadiness>>;
  smoke: Awaited<ReturnType<typeof runPostgresRuntimeEventRepositoryReadOnlySmoke>>;
  notes: string[];
}
