export type DatabaseSslMode = 'disable' | 'require' | 'prefer';
...
function readSslMode(value: string | undefined): DatabaseSslMode {
  if (value === 'require' || value === 'prefer' || value === 'disable') return value;
  return 'disable';
}

export function readDatabaseRuntimeConfigFromEnv(env: DatabaseRuntimeEnv): DatabaseRuntimeConfig {
