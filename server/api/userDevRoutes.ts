...
import type { UserApiHandlers } from './userApiHandlers.js';
...
function sendApiResponse(res: Response, response: ServerApiResponse<unknown>): void {
 ...
 */
export function registerUserDevRoutes(app: Express, handlers: UserApiHandlers): void {
