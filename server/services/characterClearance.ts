...
export function createSyntheticActorSnapshot(actorRef: RoomActorRefSummary): ActorSnapshot {
 ...
 */
export function hashActorSnapshot(snapshot: ActorSnapshot): ActorSnapshotHash {
...
export function inspectActorSnapshot(snapshot: ActorSnapshot, campaignId: string): InspectionResult {
  return {
