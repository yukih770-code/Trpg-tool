...
async function main() {
    ...
    const result = await runPostgresActorRepositoryRollbackWriteSmoke();
    const report = {
        ...
        notes: [
            ...
            'It creates a deterministic smoke owner user + actor inside one transaction, then rolls back.',
